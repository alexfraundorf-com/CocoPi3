...
then
	...
	xroar -c $HOME/.xroar/xroar.conf -default-machine dragon64 -load "$floppy" $XROARPARMS
    ...
    xroar -c $HOME/.xroar/xroar.conf -default-machine dragon64 -ao-fragments 1 $XROARPARMS
