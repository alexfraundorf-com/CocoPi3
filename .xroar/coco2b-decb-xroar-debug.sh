...
then
    ...
    then
      ...
      #xroar -c $HOME/.xroar/xroar.conf -default-machine coco2bus -ao-fragments 1 -load "$floppy" -debug-ui -1
      xroar -c $HOME/.xroar/xroar.conf -default-machine coco2bus -load "$floppy" -debug-ui -1 $XROARPARMS
    ...
    #xroar -c $HOME/.xroar/xroar.conf -default-machine coco2bus -ao-fragments 1 -debug-ui -1 $XROARPARMS
    xroar -c $HOME/.xroar/xroar.conf -default-machine coco2bus -debug-ui -1 $XROARPARMS
