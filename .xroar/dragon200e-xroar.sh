...
then
	...
	xroar -c $HOME/.xroar/xroar.conf -default-machine dragon200e -load "$floppy" $XROARPARMS
    ...
    xroar -c $HOME/.xroar/xroar.conf -default-machine dragon200e -ao-fragments 1 $XROARPARMS
