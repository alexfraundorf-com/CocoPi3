    ...
    case $RETVAL in
        ...
        17) mountFloppy.sh /media/share1 && CocoPi3-menu-Utilities.sh;;
        18) mountXRoarFloppy.sh /media/share1 && CocoPi3-menu-Utilities.sh;;
        19) mountXRoarCassette.sh /media/share1/cassette && CocoPi3-menu-Utilities.sh;;
        20) mountXRoarBin.sh /media/share1 && CocoPi3-menu-Utilities.sh;;
        21) mountXRoarROM.sh /media/share1/roms && CocoPi3-menu-Utilities.sh;;
        22) mountShow.sh && CocoPi3-menu-Utilities.sh;;
        23) mountClear.sh && CocoPi3-menu-Utilities.sh;;
