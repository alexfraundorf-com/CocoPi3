# CocoPi3
The CocoPi3 project is based on work from many other projects and individuals.  The sum of all the peices became the Raspbian based CocoPi3 distribution for the RPi3 (or B+).
